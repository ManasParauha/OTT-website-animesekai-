...
searchParams:{
    ...
    let videoData = {
      ...
      if (searchParams.videoDetails) {
        try {
          videoData = JSON.parse(searchParams.videoDetails);
        } catch (error) {
    ...
    return (
        <div className='flex bg-background'>
            ...
            <div className="w-full relative md:ml-32 flex flex-col overflow-x-hidden items-center ">
                ...
                <video autoPlay={true} controls src={searchParams.url || videoData.url} className=' object-fill w-full h-[40vh]  sm:h-[50vh] md:w-[80vw] md:h-[70vh]  md:mt-10 sm:mt-16 mt-20 '></video>

                <div className='flex gap-2 mt-3 w-full md:ml-28'>
                    <Image src={searchParams.thumbnail || videoData.thumbnail || poster } width={70} height={70} alt='Thumbnail' className='h-20 w-28'/>
                    <div className='flex gap-1 flex-col '>
                        <h6 className='text-foreground text-2xl font-semibold'>{searchParams.title || searchParams.seriesTitle || videoData.title}</h6>
